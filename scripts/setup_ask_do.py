    ...
    if service_file.exists():
        ...
        try:
            ...
            if success:
                ...
                print(f"  {Colors.DIM}{msg[:200]}...{Colors.END}" if len(msg) > 200 else f"  {Colors.DIM}{msg}{Colors.END}")
            else:
...
"""
    ...
    parser.add_argument("--model", default="mistral", help="Ollama model to install (default: mistral)")
