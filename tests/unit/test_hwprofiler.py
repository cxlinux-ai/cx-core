...
""",
    ...
    def test_detect_cpu_intel_xeon(self, mock_subprocess, mock_file):
        ...
        mock_subprocess.return_value = MagicMock(returncode=0, stdout="x86_64\n")
...
""",
    ...
    def test_detect_storage_nvme(self, mock_exists, mock_subprocess):
        ...
        # Mock lsblk output
        mock_subprocess.return_value = MagicMock(returncode=0, stdout="nvme0n1 disk 2.0T\n")
    ...
    def test_detect_storage_ssd(self, mock_file, mock_exists, mock_subprocess):
        ...
        # Mock lsblk output
        mock_subprocess.return_value = MagicMock(returncode=0, stdout="sda disk 1.0T\n")
    ...
    def test_profile_complete(self, mock_network, mock_storage, mock_ram, mock_gpu, mock_cpu):
        ...
        mock_gpu.return_value = [
            {"vendor": "NVIDIA", "model": "RTX 4090", "vram": 24576, "cuda": "12.3"}
        ]
        mock_ram.return_value = 65536
        mock_storage.return_value = [{"type": "nvme", "size": 2048000, "device": "nvme0n1"}]
