...
class TestTemplate(unittest.TestCase):
    ...
    def test_template_to_dict(self):
        ...
        template = Template(
            name="test", description="Test", version="1.0.0", packages=["pkg1", "pkg2"]
        )
    ...
    def test_template_with_hardware_requirements(self):
        ...
        hw_req = HardwareRequirements(
            min_ram_mb=4096, min_cores=4, requires_gpu=True, gpu_vendor="NVIDIA"
        )
...
class TestTemplateValidator(unittest.TestCase):
    ...
    def test_validate_valid_template(self):
        ...
        template = Template(
            name="valid-template", description="Valid template", version="1.0.0", packages=["pkg1"]
        )
    ...
    def test_validate_missing_name(self):
        ...
        template = Template(name="", description="Test", version="1.0.0")
    ...
    def test_validate_missing_packages_and_steps(self):
        ...
        template = Template(name="empty-template", description="Empty template", version="1.0.0")
...
class TestTemplateManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_template_data = {
            ...
            "packages": ["package1", "package2"],
            "steps": [
                {"command": "apt update", "description": "Update packages", "requires_root": True}
            ],
        }
    ...
    def test_save_template(self):
        ...
        template = Template(
            name="new-template", description="New template", version="1.0.0", packages=["pkg1"]
        )
    ...
    def test_generate_commands_from_packages(self):
        ...
        template = Template(
            name="test", description="Test", version="1.0.0", packages=["package1", "package2"]
        )
    ...
    def test_generate_commands_from_steps(self):
        ...
        template = Template(
            ...
            description="Test",
            version="1.0.0",
            steps=[InstallationStep(command="apt install pkg1", description="Install pkg1")],
        )
...
class TestHardwareCompatibility(unittest.TestCase):
    ...
    def test_check_hardware_compatibility_no_requirements(self):
        ...
        template = Template(name="test", description="Test", version="1.0.0", packages=["pkg1"])
    ...
    def test_check_hardware_compatibility_with_requirements(self):
        ...
        hw_req = HardwareRequirements(min_ram_mb=1024, min_cores=2)
...
class TestTemplateFormat(unittest.TestCase):
    ...
    def test_save_yaml_format(self):
        ...
        template = Template(
            name="yaml-test", description="YAML test", version="1.0.0", packages=["pkg1"]
        )
    ...
    def test_save_json_format(self):
        ...
        template = Template(
            name="json-test", description="JSON test", version="1.0.0", packages=["pkg1"]
        )
