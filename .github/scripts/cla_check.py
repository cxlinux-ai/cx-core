...
CLA_DOC_URL = "https://github.com/cxlinux-ai/cx-core/blob/main/CLA.md"
CLA_SIGN_ISSUE_URL = "https://github.com/cxlinux-ai/cx-core/issues/new?template=cla-signature.yml"
